...
class SumUpExample {
    ...
    static public void twoThreads() throws InterruptedException {
        ...
        System.out.println("Two threads final count = " + finalCount + " took " + (double)(end - start)/1000 + " seconds");
    }
    ...
    static public void oneThread() {
        ...
        s.add();
        long end = System.currentTimeMillis();
        System.out.println("Single thread final count = " + s.counter + " took " + (double)(end - start)/1000 + " seconds");
    }
